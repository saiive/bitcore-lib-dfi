...
Transaction.prototype.getCustom = function (network) {
  try {
    ...
    if (checkCustom.isCustom) {
      ...
      switch (custom.txType) {
        case customTx.customTxType.createMasternode:
          custom.data = new customTx.CreateMasternode(checkCustom.br, network);
          break;
        case customTx.customTxType.resignMasternode:
          custom.data = new customTx.ResignMasternode(checkCustom.br, network);
          break;
        case customTx.customTxType.createToken:
          custom.data = new customTx.CreateToken(checkCustom.br, network);
          break;
        case customTx.customTxType.mintToken:
          custom.data = new customTx.MintToken(checkCustom.br, network);
          break;
        case customTx.customTxType.updateToken:
          custom.data = new customTx.UpdateToken(checkCustom.br, network);
          break;
        case customTx.customTxType.updateTokenAny:
          custom.data = new customTx.UpdateTokenAny(checkCustom.br, network);
          break;
        case customTx.customTxType.createPoolPair:
          custom.data = new customTx.CreatePoolPair(checkCustom.br, network);
          break;
        case customTx.customTxType.updatePoolPair:
          custom.data = new customTx.UpdatePoolPair(checkCustom.br, network);
          break;
        case customTx.customTxType.poolSwap:
          custom.data = new customTx.PoolSwap(checkCustom.br, network);
          break;
        case customTx.customTxType.addPoolLiquidity:
          custom.data = new customTx.AddPoolLiquidity(checkCustom.br, network);
          break;
        case customTx.customTxType.removePoolLiquidity:
          custom.data = new customTx.RemovePoolLiquidity(checkCustom.br, network);
          break;
        case customTx.customTxType.utxosToAccount:
          custom.data = new customTx.UtxosToAccount(checkCustom.br, network);
          break;
        case customTx.customTxType.accountToUtxos:
          custom.data = new customTx.AccountToUtxos(checkCustom.br, network);
          break;
        case customTx.customTxType.accountToAccount:
          custom.data = new customTx.AccountToAccount(checkCustom.br, network);
          break;
        case customTx.customTxType.setGovVariable:
          custom.data = new customTx.SetGovVariable(checkCustom.br, network);
          break;
        case customTx.customTxType.anyAccountsToAccounts:
          custom.data = new customTx.AnyAccountsToAccounts(checkCustom.br, network);
          break;
        default:
          break;
      }
